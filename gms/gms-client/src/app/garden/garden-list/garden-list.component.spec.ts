...
describe('GardenListComponent', () => {
  ...
  beforeEach(async () => {
    ...
    imports: [HttpClientTestingModule, RouterTestingModule, GardenListComponent], //Import GardenListComponentproviders: [GardenService]
    }).compileComponents();
  ...
  it('should filter gardens based on the search term', fakeAsync(() => {
    const mockGardens: Garden[] = [
